describe('Sails.js v1.x Sequelize hook tests with db schemes (psql)', () => {
    ...
    before(function (done) {
        ...
        const Sequelize = require('sequelize'),
            connInfo = require('./fixtures/v1.x-many-schemes-app/config/datastores').datastores.somePostgresqlServer;
        ...
        connection.query('DROP SCHEMA IF EXISTS sails, sails_img CASCADE;').then(() => {
            Sails = require('./fixtures/v1.x-many-schemes-app/app').sails;
            rc = require('rc');
